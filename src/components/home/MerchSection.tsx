...
export function MerchSection() {
    return (
        <section className="relative min-h-[80vh] flex items-center bg-black overflow-hidden">
            ...
            <motion.div
                className="relative z-10 max-w-screen-2xl mx-auto px-8 md:px-16 lg:px-24 w-full py-20"
            ...
            >
                <div className="max-w-xl flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <motion.h2 variants={fadeUp} className="font-cinzel text-6xl md:text-7xl lg:text-8xl font-black text-white leading-none tracking-tighter mb-4 drop-shadow-2xl">
                        MERCH
                    </motion.h2>

                    <motion.p variants={fadeUp} className="font-barlow text-[#780606] text-lg md:text-xl font-bold tracking-[0.6em] uppercase mb-10 pl-2">
                        COMING SOON
                    </motion.p>
