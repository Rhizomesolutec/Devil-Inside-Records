            ...
            <div className="relative z-10">
                ...
                >
                    <div className="inline-block relative">
                        <motion.span variants={fadeUp} className="font-cinzel italic text-[#780606] text-2xl md:text-3xl font-bold tracking-tight block mb-2">
                            THE COLLECTIVE
                        </motion.span>
                        <motion.h2 variants={fadeUp} className="font-bebas text-[5rem] md:text-[8rem] lg:text-[8rem] text-white leading-none tracking-tighter">
                            <span className="[-webkit-text-stroke:2px_white] text-transparent">ARTISTS</span>
                        </motion.h2>
                        {/* Decorative crown */}
                ...
                <div className="flex flex-col items-center gap-8 mt-16 px-6">
                    <div className="flex items-center gap-10">
                        <div className="text-center">
                            <div className="font-cinzel text-3xl md:text-4xl font-black text-[#780606]">20+</div>
