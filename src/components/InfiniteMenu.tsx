...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0, onActiveItemChange, onMovementChange }) => {
    ...
    <div className="relative w-full h-full">
      ...
      {activeItem && (
        <div
          ...
          `}
        >
          <p className="select-none relative text-[#120F17] top-[2px] text-[20px] md:text-[26px]">&#x2197;</p>
        </div>
      )}
    </div>
  );
