...
export const RELEASES: Release[] = [
    ...
    accent: "#780606",
    tag: "OUT NOW",
    description: "A dynamic collaboration blending raw storytelling with powerful beats. MC Mushti and AMANI KL10 fuse Malayalam hip-hop with global rap influences to create an energetic, street-inspired anthem.",
